...
for (i in amentities) {
  lst[[i]] <-  
      ggbetweenstats(complete_data_buy,
        ...
        package = "ggsci",
        title = i,
        centrality.label.args = list(size  = 9),
        ggplot.component = list(theme(plot.subtitle = element_text(size = 7, face = "bold")))
      ) +
      theme(plot.title = element_text(hjust = 0.5, size = 35), text = element_text(size = 25))  +
      xlab("")
}
...
pl1 <-  ggbetweenstats(complete_data_buy,
    ...
    package = "ggsci",
    title = "Buy data set",
    centrality.label.args = list(size  = 13),
    ggplot.component = list(theme(plot.subtitle = element_text(size = 7, face = "bold")))
  ) +
  theme(plot.title = element_text(hjust = 0.5, size = 35), text = element_text(size = 25))  
