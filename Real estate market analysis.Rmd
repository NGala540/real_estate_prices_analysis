...
```{r}
ggplot(data_buy, aes(fill=hasElevator, y=price_per_m2, x=type)) + 
...
```{r}
mosaicplot(table(data_buy$type, data_buy$buildingMaterial), color = c("darkred", "gold"), xlab ="Type of housing", ylab = "Building material", main="The relationship between the type of housing and the construction material (")
mosaicplot(table(data_rent$type, data_rent$buildingMaterial), color = c("darkred", "gold"), xlab ="Type of housing", ylab = "Building material", main="The relationship between the type of housing and the construction material")
