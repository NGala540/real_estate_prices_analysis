...
theme_set(theme_classic(base_size = 45))
```
...
```{r}
mosaicplot(table(data_buy$type, data_buy$buildingMaterial), color = c("darkred", "grey"), xlab ="Type of housing", ylab = "Building material", main="The relationship between the type of housing\n and the construction material")
mosaicplot(table(data_rent$type, data_rent$buildingMaterial), color = c("darkred", "grey"), xlab ="Type of housing", ylab = "Building material", main="The relationship between the type of housing\n and the construction material")
...
This project aims to contribute to a deeper understanding of real estate market dynamics, enabling informed decision-making for investors, buyers, and policymakers.
